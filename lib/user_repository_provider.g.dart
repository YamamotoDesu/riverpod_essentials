...
String _$userHash() => r'ec2cc260dd580cee4af647bc97ca0fa39b0b76c5';
...
/// See also [user].
class UserFamily extends Family<AsyncValue<List<User>>> {
  /// See also [user].
  const UserFamily();
...
/// See also [user].
class UserProvider extends AutoDisposeFutureProvider<List<User>> {
  /// See also [user].
  UserProvider(
    String companyId,
  ) : this._internal(
  ...
  Override overrideWith(
    FutureOr<List<User>> Function(UserRef provider) create,
  ) {
  ...
  bool operator ==(Object other) {
    return other is UserProvider && other.companyId == companyId;
  }
...
mixin UserRef on AutoDisposeFutureProviderRef<List<User>> {
  /// The parameter `companyId` of this provider.
  String get companyId;
}

class _UserProviderElement extends AutoDisposeFutureProviderElement<List<User>>
    with UserRef {
  _UserProviderElement(super.provider);

  @override
  String get companyId => (origin as UserProvider).companyId;
}
